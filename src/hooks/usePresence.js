...
export function usePresence() {
  ...
  }, [getAuthHeader, isAuthenticated, isAuthRoute, loading, location.pathname]);
  ...
  useEffect(() => {
    if (loading || isAuthRoute || !isAuthenticated) return;
    ...
    previousPathRef.current = location.pathname;
  }, [isAuthenticated, isAuthRoute, loading, location.pathname, pingPresence]);
