...
const PLANAR_WORLDS = [
  { id: 'world_3', name: 'Simulated Universe: World 3', location: 'Herta Space Station', relics: ['Space Sealing Station', 'Fleet of the Ageless'], relicSetIds: ['space-sealing-station', 'fleet-of-the-ageless'], focus: ['ATK / Support'] },
  { id: 'world_4', name: 'Simulated Universe: World 4', location: 'Herta Space Station', relics: ['Talia: Kingdom of Banditry', 'Sprightly Vonwacq'], relicSetIds: ['talia-kingdom-of-banditry', 'sprightly-vonwacq'], focus: ['Break Effect / Action Advance'] },
  { id: 'world_5', name: 'Simulated Universe: World 5', location: 'Herta Space Station', relics: ['Pan-Cosmic Commercial Enterprise', 'Celestial Differentiator'], relicSetIds: ['pan-cosmic-commercial-enterprise', 'celestial-differentiator'], focus: ['EHR / Crit DMG'] },
  { id: 'world_6', name: 'Simulated Universe: World 6', location: 'Herta Space Station', relics: ['Belobog of the Architects', 'Inert Salsotto'], relicSetIds: ['belobog-of-the-architects', 'inert-salsotto'], focus: ['DEF / Ultimate-FUA DMG'] },
  { id: 'world_7', name: 'Simulated Universe: World 7', location: 'Herta Space Station', relics: ['Rutilant Arena', 'Broken Keel'], relicSetIds: ['rutilant-arena', 'broken-keel'], focus: ['Basic-Skill DMG / Team Crit DMG'] },
  { id: 'world_8', name: 'Simulated Universe: World 8', location: 'Herta Space Station', relics: ['Firmament Frontline: Glamoth', 'Penacony, Land of the Dreams'], relicSetIds: ['firmament-frontline-glamoth', 'penacony-land-of-the-dreams'], focus: ['SPD-gate DMG / Energy Support'] },
  { id: 'world_9', name: 'Simulated Universe: World 9', location: 'Herta Space Station', relics: ['Sigonia, the Unclaimed Desolation', 'Izumo Gensei and Takama Divine Realm'], relicSetIds: ['sigonia-the-unclaimed-desolation', 'izumo-gensei-and-takama-divine-realm'], focus: ['Wave-Scaling Crit / Double-Path Crit'] },
  { id: 'world_10', name: 'Simulated Universe: World 10', location: 'Herta Space Station', relics: ['Duran, Dynasty of Running Wolves', 'Forge of the Kalpagni Lantern'], relicSetIds: ['duran-dynasty-of-running-wolves', 'forge-of-the-kalpagni-lantern'], focus: ['FUA DMG Stacking / Fire-Weak Break'] },
  { id: 'world_11', name: 'Simulated Universe: World 11', location: 'Herta Space Station', relics: ["Lushaka's Waterscape", 'The Wondrous BananAmusement Park'], relicSetIds: ['lushaka-the-sunken-seas', 'the-wondrous-bananamusement-park'], focus: ['First-slot ATK / Summon-Crit DMG'] },
...
for (const entry of [...CAVERNS, ...PLANAR_WORLDS]) {
...
export const HSR_DOMAINS = Object.freeze(
  [...CAVERNS, ...PLANAR_WORLDS].map((entry) =>
    Object.freeze({
      type: CAVERNS.includes(entry) ? 'cavern' : 'planar',
      ...entry,
      sets: entry.relics.join(' / '),
      relics: Object.freeze([...(entry.relics || [])]),
      relicSetIds: Object.freeze([...(entry.relicSetIds || [])]),
